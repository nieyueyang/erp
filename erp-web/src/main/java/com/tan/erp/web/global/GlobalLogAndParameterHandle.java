...
import com.tan.erp.common.util.IllegalStrUtil;
import com.tan.erp.common.util.StringUtil;
...
public class GlobalLogAndParameterHandle {
    ...
    //按目录拦截
    @Pointcut("execution(* com.tan.erp.web.*.ctrl..*.*(..)) " +
            "&& !execution(* com.tan.erp.web.sys.ctrl.SysPageCtrl..*(..))")
