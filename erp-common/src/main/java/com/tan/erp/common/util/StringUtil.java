...
public class StringUtil {
    ...
    public static String cast(Object object) {
        ...
        if (clazz.isArray() == false) {
            if (boolean.class == clazz) {
                if (Boolean.parseBoolean(String.valueOf(object)) == true) {
                    return "1";
                } else {
                    return "0";
                }
            ...
            for (int i = 0; i < Array.getLength(object); i++) {
                sb.append(cast(Array.get(object, i)));
    ...
    /**
     * method String cast to simple type
     *
     * @param value srt or str,str
     * @param clazz support(int/int[],boolean/boolean[],float/float[],double/
     *              double[],long/long[],byte/byte[],short,short[],BigDecimal/
     *              BigDecimal[])
     * @return
     */
    public static Object cast(String value, Class <?> clazz) {
        ...
        if (clazz.isArray() == true) {
            ...
            if (int.class == clazz.getComponentType()) {
            ...
            if (boolean.class == clazz.getComponentType()) {
            ...
            if (float.class == clazz.getComponentType()) {
            ...
            if (double.class == clazz.getComponentType()) {
            ...
            if (long.class == clazz.getComponentType()) {
            ...
            if (char.class == clazz.getComponentType()) {
            ...
            if (short.class == clazz.getComponentType()) {
            ...
            if (BigDecimal.class == clazz.getComponentType()) {
                BigDecimal[] result = new BigDecimal[temp.length];
                for (int i = 0; i < temp.length; i++) {
                    BigDecimal bigDecimal = new BigDecimal(temp[i]);
                    result[i] = bigDecimal;
                }
                return result;
            }
