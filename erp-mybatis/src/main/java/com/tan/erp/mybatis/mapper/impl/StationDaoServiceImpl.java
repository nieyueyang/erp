...
import com.tan.erp.mybatis.mapper.StationDaoService;
 ...
 */
@Service
public class StationDaoServiceImpl<T> implements StationDaoService <T> {
    ...
    public List <T> queryForList(T t) throws Exception {
        ...
        param.put("WHERE", map);
        List <T> list = sqlSessionStation.selectList("com.baseDao.select", param);
        return list;
    }
    ...
    public int insert(T t) throws Exception {
        ...
        sqlSessionStation.insert("com.baseDao.insert", param);
    ...
    public int insertBatch(List <T> list) throws Exception {
        ...
        for (T t : list) {
            ...
            param.put("VALUES", listValues);
            try {
                int i = sqlSessionStation.insert("com.baseDao.insert", param);
                resutl = i + 0;
            } catch (Exception e) {
    ...
    public int update(T t, Map map) throws Exception {
        ...
        param.put("Where", map);
        return sqlSessionStation.update("com.baseDao.update", param);
    }
    ...
    public int delete(String tableName, Map map) {
        ...
        param.put("tableName", tableName);
        param.put("Where", map);
        return sqlSessionStation.delete("com.baseDao.delete", param);
    }
    ...
    public int deleteBatch(String tableName, List <String> list) {
        ...
        map.put("list", list);
        return sqlSessionStation.delete("com.baseDao.deleteBatch", map);
    }
