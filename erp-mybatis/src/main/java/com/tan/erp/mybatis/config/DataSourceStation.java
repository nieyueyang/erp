...
public class DataSourceStation {

    private static final Logger logger = LoggerFactory.getLogger(DataSourceStation.class);
    ...
    public DruidDataSource dataSource() {
        ...
        try {
            ...
            logger.error("DruidDataSource2 URL过滤设置失败", e);
        }
    ...
    @Bean
    public ServletRegistrationBean druidServletStation() {
    ...
    @Bean
    public FilterRegistrationBean filterRegistrationStation() {
